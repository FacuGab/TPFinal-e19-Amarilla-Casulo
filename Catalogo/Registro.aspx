                                            ...
                                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                                ...
                                                <div class="mx-1 mx-md-4" id="form">
                                                    ...
                                                    <div class="d-flex justify-content-center ">
                                                        <asp:Button Text="Registrarse" runat="server" id="btnRegistro" OnClick="btnRegistro_Click" CommandName="RegistroInicial"  CssClass="btn btn-warning btn-lg flex-fill" />
                                                        <%--<a href="ListaCarrito.aspx?text=ok&reg=ok">--%>
                                                            <asp:Button Text="Registrarse y continuar" runat="server" id="btnRegistroParaCompra" OnClick="btnRegistro_Click" CommandName="RegistroCompra" CssClass="btn btn-success btn-lg flex-fill" />
                                                        <%--<a>--%>
                                                    </div>
                                                </div>
                                            </div>
